...
def project(
    ...
    w_samples = G.mapping(torch.from_numpy(z_samples).to(device), parameters[3].repeat([w_avg_samples, 1]), truncation_psi=parameters[1], truncation_cutoff=parameters[2])  # [N, L, C]
